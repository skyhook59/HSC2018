...
<html lang="en">
<head>
  <title>Stats for <?php $username = $_GET['u']; echo $username; ?></title>
  <meta charset="utf-8">
...
<body>
<div>
<form class="horizontal-form" role="form" data-validate="parsley" method="get" action="index.php">

			<p><h3>Select a name to view their stats this season</h3></p>
</div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="http://hsc.mcph.ee/HSC2017/">Home</a></li>
