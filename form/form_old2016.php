		...
		<div class="form-group">	
		 ...
		 <select id="username" name="username" data-required="true"> 
		  ...
		  <div class="form-group">
		   ...
		   <input id="pick1" name="pick1" class="input-mini" type="text" maxlength="3" value="" data-trigger="focusin focusout"  data-minlength="1" data-required="true" style="text-transform: uppercase" data-inlist="DEN, NE, PIT, NO, TB, KC, CHI, CLE, SEA, DET, IND, LA, SF, DAL, WAS, HOU, BAL, BUF, TEN, ATL, NYJ, JAX, CIN, MIA, CAR, MIN, OAK, ARI, GB, NYG, PHI, SD"/> 
	   	   </div>
	      </div>
		  ...
		  <div class="form-group">
		   ...
		   <input id="pick2" name="pick2" class="input-mini" type="text" maxlength="3" value="" data-trigger="focusin focusout" data-minlength="1" data-required="true" style="text-transform: uppercase" data-inlist="DEN, NE, PIT, NO, TB, KC, CHI, CLE, SEA, DET, IND, LA, SF, DAL, WAS, HOU, BAL, BUF, TEN, ATL, NYJ, JAX, CIN, MIA, CAR, MIN, OAK, ARI, GB, NYG, PHI, SD"/> 
		   </div>
	      </div>
		  ...
		  <div class="form-group"> 
		   ...
		   <input id="pick3" name="pick3" class="input-mini" type="text" maxlength="3" value="" data-trigger="focusin focusout" data-minlength="1" data-required="true" style="text-transform: uppercase" data-inlist="DEN, NE, PIT, NO, TB, KC, CHI, CLE, SEA, DET, IND, LA, SF, DAL, WAS, HOU, BAL, BUF, TEN, ATL, NYJ, JAX, CIN, MIA, CAR, MIN, OAK, ARI, GB, NYG, PHI, SD"/> 
	   	   </div>
	      </div>
		  ...
		  <div class="form-group"> 
		   ...
		   <input id="pick4" name="pick4" class="input-mini" type="text" maxlength="3" value="" data-trigger="focusin focusout" data-minlength="1" data-required="true" style="text-transform: uppercase" data-inlist="DEN, NE, PIT, NO, TB, KC, CHI, CLE, SEA, DET, IND, LA, SF, DAL, WAS, HOU, BAL, BUF, TEN, ATL, NYJ, JAX, CIN, MIA, CAR, MIN, OAK, ARI, GB, NYG, PHI, SD"/> 
 		   </div>
		  </div>
		  ...
		  <div class="form-group">  
		   ...
		   <input id="pick5" name="pick5" class="input-mini" type="text" maxlength="3" value="" data-trigger="focusin focusout" data-minlength="1" data-required="true" style="text-transform: uppercase" data-inlist="DEN, NE, PIT, NO, TB, KC, CHI, CLE, SEA, DET, IND, LA, SF, DAL, WAS, HOU, BAL, BUF, TEN, ATL, NYJ, JAX, CIN, MIA, CAR, MIN, OAK, ARI, GB, NYG, PHI, SD"/> 
	   	   </div>
		  </div>
